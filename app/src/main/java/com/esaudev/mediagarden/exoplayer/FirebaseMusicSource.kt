...
class FirebaseMusicSource @Inject constructor(
    ...
    suspend fun fetchMediaData() = withContext(Dispatchers.IO) {
        ...
        val allSongs = musicDataSource.getAllSongs()
    ...
    // To play one song after another and so on
    ...
    private val onReadyListeners = mutableListOf<(Boolean) -> Unit>() // Check when the user source finish the download of the songs
